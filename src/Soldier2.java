...
public class Soldier2 {
    ...
    public static void main(String[] args) {
        ...
        try (Socket socket = new Socket("Localhost", 1234)) {
            ...
            String status = "INSERT INTO " + Database.Table_Troops + " VALUES(2, 100, 100, 100, 0)";
            ...
            System.out.println("WELCOME TO THE TROOP TRACKER" + "\n" +
                    ...
                    "Your goal is to complete 10 miles with enough health, supplies and ammunition at the end of the 10 miles" + "\n"
                ...
                switch (Menuchoice) {
                    ...
                    case "3":
                        System.out.println(" You have requested a re-supply and first-aid" + "\n" +
                                            "Your health, supplies and ammunition are back to 100%" + "\n");
                        ammo = max_ammo;
                        health = max_health;
